...
export default function MiniCarousel(props) {
  ...
  const [width, toDisplay] = useState()
  ...
  function showSlides() {
    ...
    for (var i = 0; i < toDisplay; i++) {
      ...
      mySlides.push(
        <Resource
          cap={caption[currentDisplay]}
          backimg={bgImages[currentDisplay]}
          mylink={link[currentDisplay]}
        />
      )
    }
  }
